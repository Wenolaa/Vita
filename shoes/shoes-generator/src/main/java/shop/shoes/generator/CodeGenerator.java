...
public class CodeGenerator {
    ...
    public static String url = "jdbc:mysql://localhost:3306/shoes?characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true";
    public static String username="root";
    public static String password="a123456";
    //父级别包名称
    public static String parentPackage = "shop.shoes";
    //代码生成的目标路径
    public static String generateTo = "/shoes-generator/src/main/java";
    //mapper.xml的生成路径
    public static String mapperXmlPath = "/shoes-generator/src/main/resources/mapper";
    //控制器的公共基类，用于抽象控制器的公共方法，null值表示没有父类
    public static String baseControllerClassName ;// = "shop.shoes.portal.base.BaseController";
    //业务层的公共基类，用于抽象公共方法
    public static String baseServiceClassName ;   // = "shop.shoes.portal.base.BaseServiceImpl";
    //作者名
    public static String author = "shop";
    //模块名称，用于组成包名
